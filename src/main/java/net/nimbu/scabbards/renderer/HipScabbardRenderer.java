...
public class HipScabbardRenderer implements ICurioRenderer {
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack,
        ...
        //armourDepth
        poseStack.translate(0.27, 0.6, -0.35);
        if(leftHanded) {poseStack.translate(0.6, -0.11,0.0);}
        poseStack.scale(0.9375F, 0.9375F, 0.9375F);

        poseStack.mulPose(Axis.XP.rotationDegrees(-105));
        ...
        poseStack.translate(-0.03, 0.12, 0.12);
